...
### :dog2: [Bepis](https://github.com/dosyago/bepis) ![version badge](https://img.shields.io/npm/v/bepis/latest) ![download badge](https://img.shields.io/npm/dt/bepis) [![GitHub stars](https://img.shields.io/github/stars/dosyago/bepis.svg?style=social&label=Star)](https://GitHub.com/dosyago/bepis/stargazers/)
...
### :alien: [Xen](https://github.com/dosyago/xen) ![npm version](https://img.shields.io/npm/v/xen) ![npm downloads](https://img.shields.io/npm/dt/xen) 
...
### :baby_chick: [Floppsy](https://github.com/dosyago/floppsy) ![version](https://img.shields.io/npm/v/floppsy) ![npm downloads](https://img.shields.io/npm/dt/floppsy) 
...
### :stars: [Beamsplitter](https://github.com/dosyago/beamsplitter) ![version](https://img.shields.io/npm/v/beamsplitter) ![npm downloads](https://img.shields.io/npm/dt/beamsplitter) 
...
### :bento: [Tarobox](https://github.com/dosyago/tarobox) ![version](https://img.shields.io/npm/v/tarobox) ![npm downloads](https://img.shields.io/npm/dt/tarobox) 
...
### :card_file_box: [stubdb](https://github.com/crislin2046/stubdb) ![version](https://img.shields.io/npm/v/stubdb?label=version) ![npm downloads](https://img.shields.io/npm/dt/stubdb) 

**stubdb** is very simple "database" on the file system for when you're too small to fail.

### :keycap_ten: [Abacus](https://github.com/crislin2046/bitmath) ![version](https://img.shields.io/npm/v/bitmath) ![npm downloads](https://img.shields.io/npm/dt/bitmath) 

**Abacus** is bit arithmetic package to add, subtract, multiply, euclidean divide bit arrays of any size.

### :wind_chime: [Uint1Array](https://github.com/crislin2046/Uint1Array) ![version](https://img.shields.io/npm/v/uint1array) ![npm downloads](https://img.shields.io/npm/dt/uint1array) 
